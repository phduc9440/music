...
const API_BASE_URL = 'http://192.168.1.88:8080/api';
...
export const adminApi = {
  ...
  getAccounts: (page = 1, size = 20) =>
    apiClient.get<ApiResponse<PageResponse<User>>>(`/admins/accounts?page=${page}&size=${size}`),
  createAccount: (data: Record<string, unknown>) => apiClient.post<ApiResponse<User>>('/admins/accounts', data),
